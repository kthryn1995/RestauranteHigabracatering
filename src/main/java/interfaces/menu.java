...
public void añadirpedido(){
    ...
    String tipocomida =(String)jtpedido.getValueAt(fila,1);
        int opcion = Integer.parseInt(jtpedido.getValueAt(fila,2).toString());
     String descripcion =(String)jtpedido.getValueAt(fila,3);
